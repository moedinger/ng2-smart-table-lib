(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DefaultFilterComponent = /** @class */ (function (_super) {
        ...
        DefaultFilterComponent.prototype.onSFormControl = function ($event) {
            this.formControl = $event.control;
        };
        DefaultFilterComponent.prototype.onFilter = function (query) {
            this.filter.emit({
                search: query,
                field: this.column.id,
    ...
    var CheckboxFilterComponent = /** @class */ (function (_super) {
        ...
        function CheckboxFilterComponent() {
            ...
            _this.sFormControl = new core.EventEmitter();
            return _this;
        }
    ...
    var Ng2SmartTableSolComponent = /** @class */ (function () {
        ...
        Ng2SmartTableSolComponent.prototype.sort = function ($event) {
            ...
            this.sortItem = $event;
            try {
                for (var _b = __values(Array.from(this.filterItems.keys())), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var key = _c.value;
    ...
    exports.ɵbo = Ng2SmartTableSolComponent;
    exports.ɵbp = Row;
    exports.ɵbq = DataSet;
